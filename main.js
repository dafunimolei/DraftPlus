...
var DraftPlusModal = class extends import_obsidian.Modal {
  ...
  safe(sa) {
    ...
    const removePrefix = (str, prefixes2) => {
      const prefixPattern = new RegExp(`^(${prefixes2.join("|")})`);
    ...
    if (containsLetters(sad) == true) {
      new import_obsidian.Notice("\u670D\u52A1\u5668\u5730\u5740\u4E2D\u542B\u6709\u5B57\u6BCD\uFF0C\u5E94\u9075\u4ECEip\u53F7\uFF1A\u7AEF\u53E3\u53F7\u7684\u5F62\u5F0F\uFF01");
    }
    return sad;
  }
  setupWebSocket1() {
...
var DraftPlusSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Server Address").setDesc("\u670D\u52A1\u5668\u5730\u5740\uFF0C\u4E3Aip\u53F7\uFF1A\u7AEF\u53E3\u53F7\u7684\u5F62\u5F0F\u3002").addText((text) => text.setPlaceholder("\u683C\u5F0F\u4E3A\uFF1Axx.xx.xx.xx:xxx").setValue(this.plugin.settings.serveraddress).onChange(async (value) => {
